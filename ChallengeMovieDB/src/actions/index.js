...
// for removin a specific id from movies
// export const filterMovies = async (id, dispatch) => {
//   const URL = `https://api.themoviedb.org/3/movie/${id}?api_key=5e4dbaf48b58268cbff212cb6e5c98a0&language=en-US`;
//   dispatch(requestApi());
//   try {
//     const response = await fetch(URL);
//     const {results} = await response.json();
